...
const genAI = new GoogleGenerativeAI("AIzaSyDsCjgvfyY6zs3UpoHGT6ekPh9MLFd6OsY");
    ...
    <>
      ...
      <div style={styles.container} className="mt-20 h-full">
        <div style={styles.chatHeader}>
          Welcome to personalised Career Counselling
        </div>
        ...
        <div style={styles.chatBody}>
          <div style={styles.botMessage}>
            <p style={styles.messageText}>
              <>
                👋 Hello, and welcome to CareerClips – your Personal Career
                Counselor! 🎯 I'm here to help you explore, plan, and navigate
                your career journey. Whether you're: 🌱 Just starting out, 📈
                Looking to grow, or 🔄 Seeking a career shift, I've got tailored
                advice, resources, and insights for you. 👉 How can I assist you
                today? 1️⃣ Explore new career paths 2️⃣ Build a standout resume 3️⃣
                Prepare for interviews 4️⃣ Gain skills for your dream job Let’s
                get started on unlocking your potential! 🚀
              </>
            </p>
          </div>

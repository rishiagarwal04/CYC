...
router.post("/personalize/:id", async (req, res) => {
    ...
    const { interest , courses_done , current_skillset , your_future_goal } = req.body;
    ...
    try {
        ...
        const skill = await Skill.findOneAndUpdate(
            { _id: userId },
            { $set: { interest, courses_done, current_skillset, your_future_goal } },
    ...
    try {
        ...
        res.status(200).json({
            ...
            user: {
                ...
                gender: user.gender || "",
                qualitification: user.qualification || "",

    ...
    <div className="container mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="mb-6">
        ...
        {/* <textarea 
          ...
          required 
        /> */}
        <button type="submit" className="w-full p-3 bg-indigo-500 text-white font-semibold rounded-lg shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500">
          Ask Question
        </button>
      </form>
      ...
      <div className="flex flex-wrap">
        {filteredQuestions.map((question) => (
          <div key={question._id} className="w-1/3 p-4">
            <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg">

...
const RoadmapEng = () => {
  ...
  const checkpoints = [
    { id: 1, x: 70, y: 450, label: "9-10", path: "roadmap/starteng", sticker: sticker },
    { id: 2, x: 800, y: 300, label: "11-12", path: "roadmap/milestone1", sticker: sticker },
    { id: 3, x: 450, y: 150, label: "college", path: "roadmap/milestone2", sticker: sticker },
    { id: 4, x: 725, y: 100, label: "specialisation", path: "roadmap/milestone3", sticker: sticker },
